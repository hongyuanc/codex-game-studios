...
- "What would you like to validate?"
  - Options: "A specific story or epic path", "All stories in the current sprint",
...
This skill is read-only. It never edits or asks to write story files. It may draft suggestions in conversation, but applying them requires a separately authorized fix changeset or a separate authoring skill.
...
- **GAPS [list]** → surface the specific gaps and ask whether to prepare a draft fix for separate authorization or stop.
- **INADEQUATE** → surface the specific gaps and keep the story BLOCKED. Do not edit it in this workflow.
