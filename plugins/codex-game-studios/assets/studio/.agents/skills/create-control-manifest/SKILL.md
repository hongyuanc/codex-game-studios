...
### ADRs
- Search for files matching `docs/architecture/adr-*.md` and read every file
...
- **CONCERNS** → surface with one concise question, then wait for the answer with options: `Revise flagged rules` / `Accept and proceed` / `Discuss further`
