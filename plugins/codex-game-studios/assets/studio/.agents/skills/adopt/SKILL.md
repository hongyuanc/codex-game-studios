---
name: adopt
description: Audit an existing game project for Codex Game Studios artifact compatibility and produce a prioritized migration plan.
---
...
and offer to handle it immediately using one concise question, then wait for the answer. Choose the first
branch that applies:
