---
name: estimate
description: "Use when game-development work needs an effort range, confidence level, dependency analysis, or risk-based sizing."
---
...
This skill is read-only — no files are written or edited. It may recommend planning changes, but applying them requires a separately authorized changeset through the appropriate planning skill. Verdict: **COMPLETE** — estimate generated.
