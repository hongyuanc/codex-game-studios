---
name: soak-test
description: "Use when an extended play session must detect slow leaks, stability drift, fatigue, balance degradation, or sustained-play edge cases."
---
...
**When to run:**
- Polish phase — before `$codex-game-studios:gate-check release`
...
> **Engine**: [engine]
> **Generated by**: $codex-game-studios:soak-test
...
5. Run `$codex-game-studios:bug-triage sprint` after the session to integrate any S1/S2 issues

If the verdict is FAIL, run `$codex-game-studios:smoke-check` again after fixing the issues."
