---
name: content-audit
description: Compare GDD-planned content with implemented content and report coverage gaps.
---
...
2. **L0 pre-scan**: Before full-reading any GDDs, Search all GDD files for
   ...
   ```
   repository text search pattern="(## Summary|N enemies|N levels|N items|N abilities|enemy types|item types)" glob="design/gdd/*.md" output_mode="files_with_matches"
   ```
...
what has been implemented. Use repository file and text search to locate files.

**Levels / Areas / Maps:**
- repository file search `assets/**/*.tscn`, `assets/**/*.unity`, `assets/**/*.umap`
- repository file search `src/**/*.tscn`, `src/**/*.unity`
...
- repository file search `assets/data/**/enemies/**`, `assets/data/**/characters/**`
- repository file search `src/**/enemies/**`, `src/**/characters/**`
...
- repository file search `assets/data/**/items/**`, `assets/data/**/equipment/**`,
  `assets/data/**/loot/**`
- Look for `.json`, `.tres`, `.asset` data files

**Abilities / Skills / Spells:**
- repository file search `assets/data/**/abilities/**`, `assets/data/**/skills/**`,
  `assets/data/**/spells/**`
- Look for `.json`, `.tres`, `.asset` data files

**Dialogue / Conversations / Cutscenes:**
- repository file search `assets/**/*.dialogue`, `assets/**/*.csv`, `assets/**/*.ink`
- Search for dialogue data files in `assets/data/`

**Quests / Missions:**
- repository file search `assets/data/**/quests/**`, `assets/data/**/missions/**`
