...
- Runtime skill: `.agents/skills/code-review/SKILL.md`
- Runtime name: `code-review`
- Runtime trigger description: `"Use when game source or implementation files need architecture, quality, performance, standards, or testability review."`
- Native invocation: `$code-review`
...
`$code-review` is tested against the exact runtime discovery contract above. The five
