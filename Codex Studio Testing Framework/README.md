...
> Game developers using Codex Studio don't need it. To remove it entirely:
> `rm -rf "Codex Studio Testing Framework"` — nothing in `.codex/` depends on it.
...
├── CLAUDE.md              ← tells Codex how to use this framework
...
```bash
rm -rf "Codex Studio Testing Framework"
```
