...
- Runtime skill: `.agents/skills/content-audit/SKILL.md`
- Runtime name: `content-audit`
- Runtime trigger description: `Compare GDD-planned content with implemented content and report coverage gaps.`
- Native invocation: `$content-audit`
...
`$content-audit` is tested against the exact runtime discovery contract above. The five
