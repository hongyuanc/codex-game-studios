...
- Runtime skill: `.agents/skills/estimate/SKILL.md`
- Runtime name: `estimate`
- Runtime trigger description: `"Use when game-development work needs an effort range, confidence level, dependency analysis, or risk-based sizing."`
- Native invocation: `$estimate`
...
`$estimate` is tested against the exact runtime discovery contract above. The five
