...
- Runtime skill: `.agents/skills/architecture-review/SKILL.md`
- Runtime name: `architecture-review`
- Runtime trigger description: `Review the project architecture against approved GDD requirements, ADRs, engine constraints, and traceability contracts.`
- Native invocation: `$architecture-review`
...
`$architecture-review` is tested against the exact runtime discovery contract above. The five
